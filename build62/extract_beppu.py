# -*- coding: utf-8 -*-
"""第62回 別冊抽出。午前 No.1-13=am_02_01(page=No+4), No.14-15=am_02_02(p1,p2)。
午後 No.1-12=pm_02(page=No+4)。心電図(午前No.3/午後No.3)は ROTATE_270。page余白を自動トリム。
"""
import os, subprocess, sys
from PIL import Image, ImageChops
HERE=os.path.dirname(__file__); TMP='/tmp/k62'
AM1=os.path.join(HERE,'am_02_01.pdf'); AM2=os.path.join(HERE,'am_02_02.pdf'); PM=os.path.join(HERE,'pm_02.pdf')
# No -> (pdf, page)
AM_PAGES={n:(AM1,n+4) for n in range(1,14)}; AM_PAGES[14]=(AM2,1); AM_PAGES[15]=(AM2,2)
PM_PAGES={n:(PM,n+4) for n in range(1,13)}
AM_ROT={3}; PM_ROT={3}
