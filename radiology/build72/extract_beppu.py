# -*- coding: utf-8 -*-
"""第72回 別冊抽出。No→ページは ink計測(内容頁)＋OCRアンカー＋連番で確定。
...
AM_MAP = {1:[6],2:[7],3:[8],4:[9],5:[10],6:[11],7:[12],8:[13],9:[14],10:[15],11:[16,17],12:[18]}
PM_MAP = {1:[6],2:[7],3:[8],4:[9],5:[10],6:[11],7:[12,13],8:[14],9:[15],10:[16]}
ROT = {'eam': set(), 'epm': set()}
