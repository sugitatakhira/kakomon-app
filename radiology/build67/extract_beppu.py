# -*- coding: utf-8 -*-
"""第67回 別冊抽出。No→ページは ink計測(内容頁)＋OCRアンカー＋連番で確定。
...
AM_MAP = {1:[5],2:[6],3:[7],4:[8],5:[9],6:[10],7:[11],8:[13],9:[15],10:[16],11:[17]}
PM_MAP = {1:[5],2:[6],3:[7],4:[9],5:[10],6:[11],7:[12],8:[13],9:[14],10:[15],11:[16],12:[17],13:[18]}
ROT = {'eam': set(), 'epm': set()}
