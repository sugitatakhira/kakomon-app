...
# 診療放射線技師 分野ブロック(午前・午後 共通。第67回の出題順から導出)。合計100。
...
def main():
    ...
    with open(os.path.join(HERE,'..','診療放射線技師_第67回.csv'),'w',encoding='utf-8-sig',newline='') as f:
