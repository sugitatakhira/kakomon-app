# -*- coding: utf-8 -*-
"""第65回 別冊抽出。No→ページは ink計測(内容頁)＋OCRアンカー＋連番で確定。
...
AM_MAP = {1:[5],2:[6],3:[7],4:[8],5:[10],6:[11,12],7:[13],8:[14],9:[15],10:[16],11:[18,19],12:[20],13:[21],14:[22]}
PM_MAP = {1:[5],2:[6],3:[7],4:[8],5:[9],6:[11],7:[13],8:[15],9:[16],10:[17]}
ROT = {'eam': set(), 'epm': set()}
