# -*- coding: utf-8 -*-
"""第70回データを base アプリ(radiology/kakomon-webapp.html)に埋め込んで
radiology/kakomon-webapp-70.html を出力。統合版生成 gen_all.py が
`const KOKUSHI_70 = [...]` を取り出して合成する(臨床検査技師版と同方式)。"""
import json, os
...
old_b='// ===== 起動 =====\nloadData();\nrender();'
new_b=('// ===== 起動 =====\nloadData();\n'
       'if (questions.length === 0 && typeof KOKUSHI_70 !== "undefined") {\n'
...
print('wrote radiology/kakomon-webapp-70.html', len(src), 'bytes')
