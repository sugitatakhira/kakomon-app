# -*- coding: utf-8 -*-
"""第69回 別冊抽出。No→ページは ink計測(内容頁)＋OCRアンカー＋連番で確定。
...
AM_MAP = {1:[6,7],2:[8],3:[9],4:[10],5:[11],6:[12],7:[13],8:[14],9:[15],10:[16],11:[17],12:[18],13:[19],14:[20]}
PM_MAP = {n:[n+5] for n in range(1,13+1)}
ROT = {'eam': set(), 'epm': set()}
