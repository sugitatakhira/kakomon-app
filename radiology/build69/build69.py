...
# 診療放射線技師 分野ブロック(午前・午後 共通。第69回の出題順から導出)。合計100。
...
def main():
    ...
    ans = json.load(open(os.path.join(HERE,'ans69.json'),encoding='utf-8'))
    ...
    with open(os.path.join(HERE,'..','診療放射線技師_第69回.csv'),'w',encoding='utf-8-sig',newline='') as f:
