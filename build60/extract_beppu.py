# -*- coding: utf-8 -*-
"""第60回 別冊抽出。午前 No.1-11=am_02(page=No+6)、午後 No.1-14=pm_02(page=No+6)。
心電図(午前No.3/午後No.2)は ROTATE_270。余白は自動トリム。"""
import os, subprocess
from PIL import Image, ImageChops
HERE=os.path.dirname(__file__); TMP='/tmp/k60'
AM=os.path.join(HERE,'am_02.pdf'); PM=os.path.join(HERE,'pm_02.pdf')
AM_PAGES={n:(AM,n+6) for n in range(1,12)}
PM_PAGES={n:(PM,n+6) for n in range(1,15)}
AM_ROT={3}; PM_ROT={2}
